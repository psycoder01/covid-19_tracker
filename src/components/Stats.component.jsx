...
const Stats = ({data}) => {
    return (
        <div className="stats">
            ...
            <div
                className="card text-white recovered mb-3"
            >
                <div className="card-header">Recovered</div>
                <div className="card-body">
                    <h5 className="card-title"><CountUp start={0} end={data.recovered ||0} duration={3}/></h5>
                    <p className="card-text">
            ...
            >
                ...
                <div className="card-body">
                    <h5 className="card-title"><CountUp start={0} end={data.deaths ||0} duration={3}/></h5>
                    <p className="card-text">
